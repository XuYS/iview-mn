...
export default function calcTextareaWidth(uiTextNode, minRows = null, maxRows = null, useCache = false) {
    const oldWidth = uiTextNode.scrollWidth;
    if (!hiddenTextarea) {
        hiddenTextarea = document.createElement('textarea');
        document.body.appendChild(hiddenTextarea);
    }
    ...
    let width = hiddenTextarea.scrollHeight;
    let overflowY;
    ...
    if (minRows !== null || maxRows !== null) {
        ...
        hiddenTextarea.value = ' ';
        let singleRowWidth = hiddenTextarea.scrollHeight - paddingSize;
        if (minRows !== null) {
